                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Talent Hunt Applications</h6>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td class='d-flex flex-column'>
                                                <a href='manage_talent_hunt_application.php?id=" . $row['id'] . "' class='btn btn-sm btn-primary mt-2'>Manage</a>
                                                <a href='uploads/resumes/" . $row['resume_path'] . "' target='_blank' class='btn btn-sm btn-info mt-2 text-white  text-nowrap'>View CV</a> " .

                                                    //if cover letter path is not empty, display view cover letter button
