 ...
 * It includes:
 * - Displaying talent application details
...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM talents WHERE id = ?";
                        ...
                        <div class="col-12">
                            <div class="bg-light rounded h-100 p-4">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h6>Talent Application Details</h6>
                                    <a href="talent_hunt_applications.php" class="btn btn-secondary btn-sm">Back to Applications</a>
                                </div>

                                <form action="controllers/update_talent_hunt_status_controller.php" method="POST">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="<?php echo htmlspecialchars($application['phone_number']); ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control"
                                                value="<?php echo htmlspecialchars($application['skills']); ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control"
                                                value="&#x20A6;<?php echo htmlspecialchars($application['start_date']); ?>"
                                                readonly>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Salary Expectation</label>
                                            <input type="text" class="form-control"
                                                value="<?php echo htmlspecialchars($application['salary_expectation']); ?>"
                                                readonly>
                                        </div>
                                    ...
                                    <!-- Delete Application -->
                                    <a href="controllers/delete_talent_hunt_application_controller.php?id=<?php echo $application['id']; ?>"
    ...
    header('Location: talent_hunt_applications.php');
    exit();
}
?>